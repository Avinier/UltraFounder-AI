...
SECRET_KEY = 'django-insecure-a+s%=58=ne3bm4$%(gd*-ui9pq$+0rrv_tla#idc3(_bia8=_3'
...
WSGI_APPLICATION = 'SuperServer.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'quantumsenses',
        'USER': 'quantumsenses_user',
        'PASSWORD': 'hu%$^8hvjwk(NSDF',
        'HOST': '192.168.1.74',
        'PORT': '3306',
    }
}
